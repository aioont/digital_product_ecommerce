...
from services.models import Services, ServiceProvider #, ProviderMessage
from core.models import AdminMessage
from services.forms import AdminMessageForm #, ProviderMessageForm 
...
def search_services(request):
    ...
    if service_query:
        ...
        service_providers = ServiceProvider.objects.filter(Q(sp_name__icontains=service_query))
...
# def view_messages_service_provider(request):
#     sp_msg = ProviderMessage.objects.all()

#     return render(request, 'view_message_service_provider.html',{
#         'sp_msg': sp_msg,
#     })
